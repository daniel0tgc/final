...
export function AgentDetailsTabs({ agent }: AgentDetailsTabsProps) {
  ...
  useEffect(() => {
    // Fetch all agents for A2A communication
      ...
      <TabsContent value="a2a" className="mt-4">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-1">
            <A2AMessageComposer sourceAgent={agent} allAgents={allAgents} />
          </div>
        </div>
      </TabsContent>
      ...
      <TabsContent value="settings" className="mt-4">
        <div className="bg-muted/50 border rounded-lg p-6">
          ...
          <p className="text-muted-foreground">
            Advanced agent configuration options will be available here in a
            future update.
          </p>
